...
#
# test_bgp_ecmp_16peers_2routers_krishna.py
#
# Copyright (c) 2025 by
# Test for BGP ECMP topology with 16 peers
#

"""
test_bgp_ecmp_16peers_2routers_krishna.py: Testing BGP ECMP setup
                      - 2 routers connected by 16 links
                      - r1 and r2: all links in default VRF
                      - 16 eBGP sessions (1 per link) for ECMP
...
def test_topology_setup():
    ...
    logger.info("Topology created successfully with 16-link ECMP setup")
    ...
    logger.info("BGP ECMP topology is ready for testing")
...
def test_bgp_sessions_established():
    ...
    def check_r1_sessions(router):
        ...
        try:
            ...
            msg = "r1 total established sessions: {}/16".format(established_count)
            logger.info(msg)
    ...
    def check_r2_sessions(router):
        ...
        try:
            ...
            msg = "r2 total established sessions: {}/16".format(established_count)
            logger.info(msg)
            return established_count == 16  # Expect all 16 sessions
        except Exception as e:
...
def test_interface_verification():
    ...
    for router, router_name in [(r1, "r1"), (r2, "r2")]:
        ...
        expected_msg = "{} should have 16 interfaces, found {}".format(
            router_name, interface_count)
        assert interface_count == 16, expected_msg
